...
public class WatermarkLateDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WaterSensor> sensorDSwitchWatermark = sensorDS.assignTimestampsAndWatermarks(watermarkStrategy);

        OutputTag<WaterSensor> lateTag = new OutputTag<>("late-data", Types.POJO(WaterSensor.class));

        SingleOutputStreamOperator<String> process = sensorDSwitchWatermark.keyBy(sensor -> sensor.getId())
