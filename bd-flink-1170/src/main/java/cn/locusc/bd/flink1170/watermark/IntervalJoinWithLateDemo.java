...
public class IntervalJoinWithLateDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Tuple2<String, Integer>> ds1 = executionEnvironment
        ...
        SingleOutputStreamOperator<Tuple3<String, Integer, Integer>> ds2 = executionEnvironment
